...
@section('content')
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="py-3 flex justify-between items-center space-x-4 mb-5">
        <!-- Tombol Daftar Proyek yang mengarah ke daftar-konten -->
        <a href="/daftar-konten" class="text-lg font-semibold py-1.5 px-3 bg-blue-500 text-white rounded-md hover:bg-blue-400 transition duration-300 ease-in-out">
            Daftar Proyek
        </a>

        <!-- Tombol Tambah Proyek Baru -->
        <a href="/tambah-konten" class="text-lg py-1.5 px-3 rounded-md bg-blue-400 text-white hover:bg-blue-300 hover:text-black transition duration-300 ease-in-out">
            Tambah Proyek Baru
        </a>
    </div>
